...
We act as the data controller for personal data of registered dashboard users (contractors). We act as a data processor on behalf of contractors for personal data collected from end customers through the estimator widget.`}</Body>
            ...
            <SectionCard id="customer-data" num="03" title="End Customer Data">
              ...
              <TableRow label="Approximate location" value="Country and city-level location, worked out from your IP address at the moment you use the widget. Used only for basic usage statistics (e.g. which regions use the tool). The IP address itself is not stored alongside this, and this is separate from the fraud-prevention IP address above." />
              <TableRow label="Widget interaction data" value="Which steps of the estimator you reach, device type, browser language, and the page or campaign link that brought you to the widget. Used to help contractors and us improve the tool. Not linked to your name or contact details unless you complete the form." />
              <div style={{ display: 'flex', gap: '16px', padding: '8px 0', fontSize: '13.5px', fontFamily: FONT }}>
...
Question text sent to Anthropic for AI translation is processed transiently under Standard Contractual Clauses (GDPR Article 46) and is not stored beyond the duration of the API request. This text does not contain personal data.`}</Body>
            ...
            <SectionCard id="gdpr-rights" num="09" title="Your GDPR Rights">
              <Body>As a data subject under GDPR you have the following rights. Contact us at support@quickquote360.com to exercise any of them — we will respond within 30 days.</Body>
...
The estimator widget embedded on your website sets no cookies on your visitors. It does log basic, non-cookie interaction data (which steps were used, device type, approximate location) to help contractors and us improve the tool — see "End Customer Data" above for details.`}</Body>
            ...
            <SectionCard id="children" num="11" title="Children's Privacy">
              <Body>The Service is not directed at individuals under the age of 16. We do not knowingly collect personal data from children. If you believe a child under 16 has submitted data through the Service, please contact us at support@quickquote360.com and we will delete it promptly.</Body>
            </SectionCard>
...
Email: support@quickquote360.com`}</Body>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '6px', paddingTop: '4px' }}>
              ...
              <span style={{ fontSize: '12px', color: '#9ca3af' }}>Last updated: August 2026</span>
            </div>
          </div>
        </div>
      </div>
